...
| Appendix SA15 time-FE robustness    |        not measured | Opt-in external-data pipeline, excluded from the baseline. Its raw CZ archive is about 2.3 GB and its Arrow signal-panel cache about 2.5 GB; acquisition and an absent detailed CRSP cache can require WRDS.                                                                                      |
