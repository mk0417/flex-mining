...
%%
\section{Data-Mined Matches for Renowned Findings}\label{sec:ia-closer}

Tables \ref{tab:closer_bmdec}--\ref{tab:closer_size} expand on Table \ref{tab:closer-summary}, listing more of the data-mined accounting ratios that performed similarly to B/M, momentum, and size in the original sample periods.
